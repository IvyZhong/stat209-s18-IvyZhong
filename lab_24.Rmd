...
**Answer**: The mean of arrests of crimes. The mean is 0.172482 meaning that the majority of crimes were not arrested.
...
**Answer**: The mean is 0.2751659 meaning that the majority of crimes were not theft.
...
**Answer**: There were 38816 theft crimes happened in the city of Chicago
...
**Answer**: 36.55238 theft could happen per 1000 households.
...
**Answer**: The mean of number of arrests for the city of Chicago is 0.172482, while the mean of number of arrests of area Humboldt Park is 0.2569792. The mean is higher.
...
**Answer**: No. We can't compare the numbers since the area isn't the same.
...
```{r}
crimes_ca$theft_rate <- crimes_ca$theft_sum*1000/crimes_ca$num_households
```
...
**Answer**: The higher the median income, the lower the theft rate.
...
ggplot(crimes_ca, aes(median_income, theft_rate)) +
  geom_point() +
  geom_text(aes(label = area_name), size = 5)
```
...
**Answer**: It is a commercial place, and a lot of people go there and leave, so a higher rate of theft coming in.
